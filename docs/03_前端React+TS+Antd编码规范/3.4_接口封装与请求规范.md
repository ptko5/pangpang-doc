...
import type { User, CreateUserDTO, UpdateUserDTO, UserQueryDTO, PageResult } from '@/types';

export const getUserList = (params: UserQueryDTO): Promise<PageResult<User>> => {
